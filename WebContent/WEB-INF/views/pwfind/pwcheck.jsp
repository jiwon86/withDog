                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="pw_auth.wd" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="inputEmailName" type="text" name="mname" placeholder="Enter email Name" /><br>
                                                <label class="small mb-1" for="inputEmailAddress">이메일</label>
                                                <input class="form-control" id="inputEmailAddress" type="email" name="memail" aria-describedby="emailHelp" placeholder="Enter email address" />
                                            </div>
                                            <!-- Form Group (submit options)-->
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="login.wd">Return to login</a>
                                                <input type="submit" class="btn btn-primary" value="비밀번호찾기"></a>
                                            </div>
                                        </form>
                                    </div>
