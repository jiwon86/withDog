				 ...
				 <main>
                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <nav class="nav nav-borders">
                            ...
                            <a class="nav-link active ms-0" href="petSelectAll.wd">MyPet</a>
                                                 ...
                                                 <!-- 성별 -->
                                                   ...
                                                   <div class="row gx-3">
                                                     <label class="small mb-1" for="inputUsername">중성화 여부</label>
                                                       <div class="mb-3 col-md-6">
                                                         <div class="form-check form-checked-solid">
                                                             <input class="form-check-input" id="pneutral" name="pneutral"type="radio" name="pneutral" value='Y'>
                                                           <label class="form-check-label" for="flexRadioSolid1">O</label>
                                                         </div>
                                                       </div>
                                                       <div class="mb-3 col-md-6">
                                                           <div class="form-check form-checked-solid">
                                                           <input class="form-check-input" id="pneutral" name="pneutral" type="radio" name="pneutral" value='N'>
						                          ...
						                          <div class="mb-0">
                                                   	<label for="exampleFormControlTextarea1">특이사항을 기입해주세요(1000Byte)</label>
                                                   		<textarea class="form-control" id="pmemo" name="pmemo" rows="10" ><%=pvo.getPmemo() %>
                                                   		</textarea>
                                                   	</div>
                                                   <!-- 반려견 사진 -->
                                                   <br>
