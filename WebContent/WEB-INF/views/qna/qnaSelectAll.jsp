...
<div class="row">
	<div class="col-lg-4 mb-4" align="right">
		...
		<div class="col-12 col-xl-auto mb-3">
			<button class="btn btn-sm btn-light text-primary active me-2"
				id="I">글쓰기</button>
			 <a class="btn btn-primary" href="mymy.wd">내 문의내역 확인</a>
		</div>
	</div>
...
<tbody>
	<tr>
<!-- WEB-INF안에 있는 jsp 파일 안에는 접근이 안되기 때문에 Contrller 통해서 접근해줘야됨 그래서 index를 WEB-INF에 안 넣고 밖으로 빼둔거임 -->
