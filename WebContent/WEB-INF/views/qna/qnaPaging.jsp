...
<%
	...
	***********************************/
	...
	if(request.getParameter("groupSize") != null) {
		pageSize = Integer.parseInt(request.getParameter("groupSize"));//5
		System.out.println("groupSize >>> : " + groupSize);
	}
	
	if(request.getParameter("curPage") != null) {
		pageSize = Integer.parseInt(request.getParameter("curPage"));//1
		System.out.println("curPage >>> : " + curPage);
	}
	
	if(request.getParameter("totalCount") != null) {
		pageSize = Integer.parseInt(request.getParameter("totalCount"));//40
	...
	//0*0
	int linkPage = curPage * groupSize;
